I18N.ru = {
        ...
        examquiz_title: '✦ Лексика для экзаменов ✦', examquiz_hint: 'Наборы слов для языковых сертификационных экзаменов. Сейчас доступен весь JLPT (N5-N1), весь TOPIK (1-4) и HSK 1, другие экзамены появятся позже.', examquiz_jlpt: 'JLPT (японский)', examquiz_jlpt_title: '✦ Выберите уровень JLPT ✦', examquiz_jlpt_n5: 'N5', examquiz_jlpt_n4: 'N4', examquiz_jlpt_n3: 'N3', examquiz_jlpt_n2: 'N2', examquiz_jlpt_n1: 'N1',
        ...
        examquiz_hsk: 'HSK (китайский)', examquiz_hsk_title: '✦ Выберите уровень HSK ✦', examquiz_hsk_1: 'HSK 1',
        ...
        tool_flashcard: 'Карточки', tool_listening: 'Аудирование', tool_srs: 'Интервальное повторение',
        ...
        srs_title: '🔁 Интервальное повторение', srs_start: '🔁 Начать повторение', srs_all_done: '🎉 Отлично, сейчас нечего повторять!', srs_box_label: 'Уровень знания {n}',
        ...
        guestbook_load_more: 'Показать больше', guestbook_blocked: 'Сообщение содержит недопустимый контент, отредактируйте и отправьте снова', weather_enable: '🌤️ Показать погоду',
