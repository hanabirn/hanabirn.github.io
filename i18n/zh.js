I18N.zh = {
        ...
        nav_games: '離線小遊戲區', nav_rhythm: '其他遊戲區', rhythm_title: '✦ 其他遊戲區 ✦', rhythm_pjsekai_name: '世界計畫 成績簿', rhythm_pjsekai_desc: '記錄每首歌各難度的個人成績，還有日台服最新情報', rhythm_wuwa_name: '鳴潮圖鑑', rhythm_wuwa_desc: '收錄鳴潮所有角色、武器、聲骸資料，還有角色故事和語音', nav_guestbook: '留言板', guestbook_title: '✦ 留言板 ✦', guestbook_name: '你的名字', guestbook_message: '留下你的言語...', guestbook_send: '送出', guestbook_success: '感謝你的留言 ✦', games_title: '✦ 離線小遊戲區 ✦', game_snake_name: '貪食蛇', game_snake_desc: '吃蘋果讓蛇變長，看你能撐多久！', game_whack_name: '打地鼠式單字遊戲', game_whack_desc: '看意思找單字，考驗你的反應力！', game_back: '返回', game_score: '分數', game_start: '開始遊戲', game_snake_intro: '用方向鍵或滑動螢幕控制方向！', game_whack_pick_lang: '✦ 選擇語言 ✦', game_whack_need_cache: '請先到「單字測驗」讀取過一次這個語言的單字庫，才能離線遊玩！', game_whack_find: '找出意思是「{m}」的單字！', game_over: '遊戲結束！', game_final_score: '最終分數：{n}', game_new_best: '🎉 新紀錄！', game_restart: '再玩一次', game_2048_name: '2048 數字合併', game_2048_desc: '滑動方塊合併相同數字，挑戰湊出 2048！', game_2048_win: '🎉 你湊出 2048 了！繼續玩看看能不能更高分～', game_match3_name: '糖果消消樂', game_match3_desc: '交換糖果湊出三個以上相同種類，挑戰有限步數內拿高分！', game_combo_2: '甜蜜連擊！', game_combo_3: '美味爆擊！', game_combo_4: '糖果狂潮！',
        ...
        guide_rhythm_title: '其他遊戲區', guide_rhythm_desc: '收藏我做的其他遊戲相關網站，目前有「世界計畫」歌曲成績簿和「鳴潮圖鑑」，點擊卡片會開啟獨立的網站。',
