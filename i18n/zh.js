I18N.zh = {
        ...
        nav_quiz: '單字測驗', nav_examquiz: '檢定考試', nav_about: '關於我',
        ...
        nav_rhythm: '遊戲區', rhythm_title: '✦ 遊戲區 ✦', rhythm_hint: '點擊卡片會前往各自獨立的網站，你在那邊新增/修改的資料都會保存在裝置上，不會因為關閉畫面而不見。', rhythm_pjsekai_name: '世界計畫 成績簿', rhythm_pjsekai_desc: '記錄每首歌各難度的個人成績，還有日台服最新情報', rhythm_wuwa_name: '鳴潮圖鑑', rhythm_wuwa_desc: '收錄鳴潮所有角色、武器、聲骸資料，還有角色故事、語音和最新更新情報', rhythm_osu_name: 'osu! 收藏', rhythm_osu_desc: '收藏 osu! Beatmap 並依模式分類，查詢任何人的四種模式 PP，還有官方新聞與社群賽事情報', nav_guestbook: '留言板', guestbook_title: '✦ 留言板 ✦', guestbook_name: '你的名字', guestbook_message: '留下你的言語...', guestbook_send: '送出', guestbook_success: '感謝你的留言 ✦', nav_feedback: '建議&改進', feedback_title: '✦ 建議&改進 ✦', feedback_hint: '覺得網站有哪裡可以做得更好嗎？在這裡告訴我，只有我看得到你的訊息，其他訪客不會看見。', feedback_placeholder: '寫下你的建議...', feedback_submit: '送出', feedback_success: '您的回覆訊息已傳送，感謝您的回饋！',
